...
/* ── role config ───────────────────────────────────────── */
const roleConfig: Record<string, { icon: IconType; color: string; bgColor: string; label: string; description: string }> = {
    director: {
        icon: MdMilitaryTech,
        color: "text-violet",
            ...
            {loading ? (
                ...
                <div className="flex-1 flex items-center justify-center">
                    <div className="text-center">
                        <MdGroups className="text-5xl text-text-muted mb-3 block mx-auto" />
                        ...
                        <div className="obs-card group">
                            ...
                            <div className="relative">
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <MdAnalytics className="text-amber text-xl" />
                                </div>
                        ...
                        <div className="obs-card group">
                            ...
                            <div className="relative">
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <MdGroups className="text-emerald text-xl" />
                                </div>
                        ...
                        <div className="obs-card group">
                            ...
                            <div className="relative">
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <MdCategory className="text-gold text-xl" />
                                </div>
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mb-1.5">
                        ...
                        {decision.iteration !== null && (
                            <>
                                <span className="text-text-muted">&middot;</span>
                                <span className="text-xs text-text-muted inline-flex items-center">
                                    <MdReplay className="text-xs align-middle mr-0.5" />
                            ...
                            {decision.reasoning && (
                                <div>
                                    <p className="text-[11px] font-mono text-text-muted uppercase tracking-widest mb-1.5 flex items-center gap-1">
                                        <MdPsychology className="text-sm" />
