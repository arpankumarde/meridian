          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="stagger-children">
              ...
              <p className="font-sub mb-10 text-text-secondary leading-relaxed animate-rise opacity-0 [animation-delay:160ms]">
                Unlike simple search wrappers, Meridian employs a tiered approach to truth. A Director agent plans the audit strategy, Manager agents verify sub-claims, and a pool of Intern agents gather evidence from high-signal sources.
              </p>
